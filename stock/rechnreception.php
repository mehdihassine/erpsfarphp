...
//SELECT  nreception, COUNT(article_id) as nbrarticle ,nomfr,
...
//SUM(prixTotal) as prixTotal  FROM stock , fournisseur  WHERE (fournisseur.idfr=stock.fournisseur_id  )  GROUP BY nreception " ;
		...
		numfact, SUM(quantite) as quantiterecep,dateachat,
		SUM(prixTotal) as prixTotal  FROM stock , fournisseur  WHERE fournisseur.idfr=stock.fournisseur_id  AND stock.nreception= '$nreception' GROUP BY nreception " ;
