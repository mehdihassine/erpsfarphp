...
$postdata = file_get_contents("php://input"); 
    ...
    if (isset($postdata)) {
		...
		$sql =  "SELECT * FROM factureachat f , article a ,fournisseur p  where f.nfacture ='$nfacture' and f.idarticle =a.idarticle  and f.idfournisseur=p.idfr order by f.nligne" ;
